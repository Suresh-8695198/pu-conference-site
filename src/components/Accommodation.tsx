    ...
    <section id="accommodation" className="py-0 bg-cream">
      <div className="container mx-auto px-4">
        ...
        <div className="bg-white border border-slate-200 rounded-lg p-8 mb-12 shadow-sm">
          ...
          {/* Accommodation and Feedback Forms Section */}
          <div className="mt-8 grid md:grid-cols-2 gap-8">
            {/* Accommodation Form */}
            <div className="bg-white border-2 border-blue-200 rounded-xl p-6 hover:shadow-xl transition-all duration-300 relative overflow-hidden">
              ...
              <div className="flex flex-col items-center gap-6 relative z-10">
                ...
                <div className="flex flex-col items-center w-full">
                  <a
                    ...
                    className="relative inline-flex items-center justify-center gap-3 bg-blue-600 text-white px-8 py-4 rounded-lg font-display font-bold text-base md:text-lg hover:bg-blue-700 transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-1 transform group w-full max-w-xs"
                  >
                    {/* Animated Hand Icon */}
                    <svg 
            ...
            {/* Feedback Form */}
            <div className="bg-white border-2 border-green-200 rounded-xl p-6 hover:shadow-xl transition-all duration-300 relative overflow-hidden">
              <div className="relative z-10 text-center mb-6">
                ...
                <h4 className="font-display font-bold text-xl md:text-2xl text-green-900 mb-2">
                  Share Your Feedback
                </h4>
                <p className="text-gray-700 text-sm md:text-base font-medium">
                  Your valuable feedback helps us improve the conference experience
                </p>
              </div>
              ...
              <div className="flex flex-col items-center gap-6 relative z-10">
                {/* QR Code */}
                <div className="flex flex-col items-center group">
                  <div className="bg-white p-4 rounded-xl shadow-lg border-2 border-green-200 hover:border-green-600 hover:scale-105 transition-all duration-300">
                    <img 
                ...
                <div className="flex items-center gap-3 w-full">
                  ...
                  <span className="text-green-700 font-bold text-sm px-3 py-1 bg-green-50 rounded-full shadow-sm border border-green-200">OR</span>
                  <div className="flex-1 h-px bg-green-200"></div>
                </div>
                ...
                <div className="flex flex-col items-center w-full">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="relative inline-flex items-center justify-center gap-3 bg-green-600 text-white px-8 py-4 rounded-lg font-display font-bold text-base md:text-lg hover:bg-green-700 transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-1 transform group w-full max-w-xs"
                  >
                    <svg 
                      className="w-6 h-6 md:w-7 md:h-7 animate-pulse group-hover:scale-110 transition-transform duration-300" 
                      fill="currentColor" 
